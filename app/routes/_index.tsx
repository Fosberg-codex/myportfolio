              ...
              <>
                <div className="flex flex-col justify-center gap-2 mt-4">
                  <div className="text-sm sm:text-base"> 
                    I am Fosberg, I read Computing Physics at the university. In school, I created machine learning models and software applications to solve complex physics simulations. Just before completion, I decided to focus on building tools for scientists, developers, students and specific niches. Fast forward, I created https://www.lernexe.com/ with my colleague, an AI platform to help students learn, which we engineered to support over 5,000 weekly visitors. Being passionate about problem-solving and research, I would have hated myself if I hadn't published my final year college research: https://iopscience.iop.org/article/10.1088/2057-1976/ad3cdf.
                    As my philosophy evolved to focus on building solutions faster and safer. My love for fishing data led me to again build (https://africabase.vercel.app), a unified datasets hub for Africa, owned by Africans, which I am currently managing. I work on machine learning tasks almost every day, from computer vision to exploring new ML techniques. I created Prossa, a python package(https://prossa.vercel.app) to help solve the pain points in data preprocessing, which is often said to take up 70% of the ML workflow. From design, frontend, backend, DevOps and MLOps I have been there.
                    I have created many cool projects that I have either abandoned or not shipped, but they have greatly contributed to my learning. Now, my goal is to give back to the community that inspired me to build these  and also help businesses ship fast. Currently, I am building Plutofloww, a no-code/minimal-code platform that helps data scientists and ML engineers run inferences on their ML on web. 
